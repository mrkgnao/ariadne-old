...
module Edible.Column (-- * 'Column'
                       ...
                       -- * Entire module
                       module Edible.Column)  where

import           Edible.Internal.Column (Column, Nullable, unsafeCoerce, unsafeCoerceColumn,
...
-- function.
--
-- The Edible equivalent of 'Data.Maybe.maybe'.
...
--
-- The Edible equivalent of 'Data.Maybe.fromMaybe'.
...
--
-- The Edible equivalent of 'Data.Maybe.Just'.
