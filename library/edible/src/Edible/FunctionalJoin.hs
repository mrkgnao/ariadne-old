...
-- want the standard interface then use "Edible.Join".

{-# LANGUAGE FlexibleContexts      #-}
{-# LANGUAGE MultiParamTypeClasses #-}

module Edible.FunctionalJoin where
...
import           Edible.Internal.Column         (Column, Nullable)
import qualified Edible.Internal.Join           as IJ
import qualified Edible.Internal.Operators      as IO
import qualified Edible.Internal.Unpackspec     as IU
