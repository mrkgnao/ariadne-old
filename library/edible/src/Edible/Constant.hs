...
-- 'Column' creation functions in "Edible.PGTypes".  Besides
-- convenience it doesn't provide any additional functionality.
--
-- It can be used with functions like 'Edible.Manipulation.runInsert'
...
--      => Connection
--      -> 'Edible.Table' columns columns'
--      -> haskells
--      -> IO Int64
--   customInsert conn table haskells = 'Edible.Manipulation.runInsert' conn table $ 'constant' haskells
-- @
--
