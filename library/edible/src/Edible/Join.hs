...
--
-- "Edible.FunctionalJoin" provides a much nicer, Haskelly, interface
...
--          -> (((Column a, Column b), (Column c, Column (Nullable d))) -> Column 'Edible.PGTypes.PGBool')
...
module Edible.Join where

import qualified Edible.Internal.Unpackspec as U
import qualified Edible.Internal.Join as J
